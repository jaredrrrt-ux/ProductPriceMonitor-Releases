...
This repository contains only release installers, checksums, update manifests, release notes, and this README. It does not contain source code, databases, monitored product URLs, logs, credentials, QA data, Edge store-submission packages, or user information.
